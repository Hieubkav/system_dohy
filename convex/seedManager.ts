...
export const DEPENDENCY_LEVELS: Record<number, string[]> = {
  0: ['roles', 'postCategories', 'productCategories', 'serviceCategories', 'courseCategories', 'settings', 'media', 'adminModules', 'systemPresets'],
  1: ['users', 'customers'],
  2: ['posts', 'products', 'services', 'courses', 'menus', 'homepage', 'subscriptions'],
